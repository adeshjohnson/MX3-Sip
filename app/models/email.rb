...
class Email < ActiveRecord::Base
  ...
  ALLOWED_VARIABLES = ["balance_transferrer", "server_ip", "device_type", "device_username", "device_password", "login_url", "login_username", "username", "first_name",
                       "last_name", "full_name", "balance", "nice_balance", "warning_email_balance", "nice_warning_email_balance",
                       "currency", "user_email", "company_email", "email", "company", "primary_device_pin", "login_password", "user_ip", "val_hash",
  ...
  def Email.email_variables(user, device = nil, variables = {}, options = {})
	...
	variables[:payment_amount] =  Email.nice_number(variables[:payment_amount]).to_s if variables[:payment_amount]
    opts = {
